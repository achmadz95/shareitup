		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href=<?php echo base_url().""?> class="logo pull-left"><img src="<?php echo base_url('assets/img/logo.png'); ?>" class="site_logo" alt="" style="width: 11%; height: 100%; margin-left:-10px;" ></a>
			...
			<section class="main-content">				
				<div class="row">				
					...
					<div class="span12"> 
						...
						<!-- Tombol untuk menampilkan modal profil-->
						...
						<div class="modal-dialog">
							...
							<div class="modal-body">
								...
								<div class="form-group"> 
		  							...
		  							<input style="width: 500px;" type="email" class="form-control" id="email" name="email" required="" value="<?php echo $x['email']; ?>">
								</div>
								<div class="form-group"> 
		  							<label for="username">Username</label>
		  							<input style="width: 500px;" type="text" class="form-control" id="username" name="username" required="" value="<?php echo $x['username']; ?>">
								</div>
								<div class="form-group"> 
		  							<label for="password">Password</label>
		  							<input style="width: 500px;" type="password" class="form-control" id="password" name="password" required="" value="">
								</div>
								<div class="form-group"> 
